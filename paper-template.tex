...
%  the end of the "Font face packages" block for personal / camera-ready builds.
%==============================================================================
...
%  Stack 4 (Minion Pro, commercial) is my personal camera-ready design, left
%  commented out.
%
...
%  active for an arXiv upload, the %%not-arxiv-font%% lines (Minion Pro) for the
...
% 2. Libertinus (serif + Biolinum sans) + Inconsolata   (free)
%    Serif and sans are siblings, so this is the most internally coherent stack.
%\usepackage[mono=false]{libertine}                      % serif + sans
...
%    My own camera-ready design; Minion Pro must be installed separately. A
%    build script swaps it in (via the %%not-arxiv-font%% tags) for the
%    non-arXiv build.
